...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    CW_TOGG,        MT(MOD_LGUI, KC_Z),MT(MOD_LALT, KC_X),KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       MT(MOD_RALT, KC_DOT),KC_SLASH,       KC_MEH,         
                                                    LT(3, KC_SPACE),QK_REP,                                         TT(1),          LT(2, KC_ENTER)
  ),
  [1] = LAYOUT_voyager(
  ...
  [3] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN1,        OM_U,        KC_MS_BTN2,        KC_MS_WH_UP,                                         KC_TRANSPARENT, KC_HOME,        KC_UP,          KC_END,         KC_TRANSPARENT, KC_TRANSPARENT, 
